...
export default function AddUserPage() {
    ...
    useEffect(() => {
        if (searchParams.get('id')) {
            ...
            API.user.getUserDetails(searchParams.get('id'))
    ...
    const updateUserDetails = async (e) => {
        ...
        try {
            ...
            const res = await API.user.addAndUpdateTransactions(user, searchParams.get('id'));
            if (res && res.status === 200) {
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-3xl shadow-xl py-6 px-10 rounded-md">
            ...
            </div>
            {
                initialLoading ?
                    ...
                    :
                    <form onSubmit={!searchParams.get('id') ? handleSubmit : updateUserDetails}>
